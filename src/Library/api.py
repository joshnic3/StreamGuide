...
class API:
    ...
    def record_click_through(self, listing_id):
        self.catalog.increment_listing_recommendation_score(listing_id, constants.SCORE.CLICK_THROUGH)

    def add_to_watch_list(self, listing_id, user_id):
        # TODO Add user watchlist logic.
        self.catalog.increment_listing_recommendation_score(listing_id, constants.SCORE.WATCH_LIST_ADD)

    def remove_from_watch_list(self, listing_id, user_id):
        # TODO Add user watchlist logic.
        self.catalog.increment_listing_recommendation_score(listing_id, constants.SCORE.WATCH_LIST_REMOVE)
