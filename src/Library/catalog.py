from Library.data import ServicesDAO, TitlesDAO, ListingsDAO, ListingServiceMappingDAO, RecommendationScoresDAO
...
class Catalog:
    ...
    def __init__(self, database_file_path):
        ...
        self._recommendation_scores = RecommendationScoresDAO(database_file_path)
        ...
        if listing_rows is not None:
            for listing in listing_rows:
                ...
                if display_title in listing_display_titles:
                    ...
                    self._recommendation_scores.write(listing_id)
    ...
    def increment_listing_recommendation_score(self, listing_id, increment):
        current_score = self._recommendation_scores.read(listing_id)
        if current_score is not None:
            self._recommendation_scores.update(listing_id, int(current_score) + increment)
        else:
            self._recommendation_scores.write(listing_id, increment)
